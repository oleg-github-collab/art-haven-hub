              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Ми використовуємо файли cookie для покращення вашого досвіду на платформі, 
                    аналізу трафіку та персоналізації контенту.{" "}
                    ...
                    {showSettings && (
                      ...
                      >
                        <div className="space-y-3 p-4 rounded-xl bg-accent/50 border border-border">
                          <CookieOption
                            label="Необхідні"
                            description="Забезпечують базову роботу платформи"
                            checked={preferences.necessary}
                            disabled
                          />
                          <CookieOption
                            label="Функціональні"
                            description="Зберігають ваші налаштування"
                            checked={preferences.functional}
                            onChange={(v) => setPreferences({ ...preferences, functional: v })}
                          />
                          <CookieOption
                            label="Аналітичні"
                            description="Допомагають покращити платформу"
                            checked={preferences.analytics}
                            onChange={(v) => setPreferences({ ...preferences, analytics: v })}
                          />
                          <CookieOption
                            label="Маркетингові"
                            description="Персоналізована реклама"
