...
import { Eye, EyeOff, Mail, Lock, User, ArrowRight, Palette, Check, X } from "lucide-react";
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="firstName" className="pl-10 h-11" required />
                </div>
              </div>
              <div className="space-y-2">
                <Label htmlFor="lastName">{t.auth.last_name}</Label>
                <Input id="lastName" className="h-11" required />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="email" type="email" placeholder="you@example.com" className="pl-10 h-11" required />
              </div>
            </div>
